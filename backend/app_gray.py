...
face_mesh = mp_face_mesh.FaceMesh(
    ...
    max_num_faces=1,
    refine_landmarks=True,  # 使用更精细的面部网格
...
class BlinkDetector:
    ...
    def process_frame(self, frame):
        ...
        for face_landmarks in results.multi_face_landmarks:
            ...
            # 整体眨眼检测
            if left_ratio < self.threshold and right_ratio < self.threshold:
                ...
                if self.blink_counter > 2 and self.blink_counter < 14 :
                    self.total_blinks += 1
            ...
            # 右眼眨眼检测
            if right_ratio < self.threshold and left_ratio > self.threshold:
